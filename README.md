...
▶ [tyyppi](https://github.com/am-kantox/tyyppi)  
⤷ Library bringing erlang typespecs to runtime
⤷ <small style="color: #999;">elixir, guards, validation</small>  

▶ [tempus](https://github.com/am-kantox/tempus)  
⤷ Easy handling of time periods aka slots, like business days, holidays, etc  
⤷ <small style="color: #999;">elixir, time, validation</small>  

▶ [cloister](https://github.com/am-kantox/cloister)  
⤷ The helper application to manage cluster of nodes  
⤷ <small style="color: #999;">elixir, distributed, clustering</small>  

▶ [rambla](https://github.com/am-kantox/rambla)  
⤷ Easy publishing to many different targets  
⤷ <small style="color: #999;">elixir, publishing</small>  
